@extends('layouts.dashboard-layout') {{-- Uses the new layout --}}
    ...
    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 rounded-lg shadow-sm mb-6" role="alert">
        <div class="flex">
            ...
            <div>
                ...
                <p class="text-sm">Welcome to the FRS System. You are logged in as <strong>Student</strong>.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transform hover:-translate-y-1 transition-all duration-300">
            <div class="p-6">
                ...
                {{-- Changed text --}}
                <p class="text-sm text-gray-500 mb-4">Register or view your course enrollment.</p>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transform hover:-translate-y-1 transition-all duration-300">
            <div class="p-6">
                ...
                {{-- Changed text --}}
                <p class="text-sm text-gray-500 mb-4">Check your class schedule for this semester.</p>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transform hover:-translate-y-1 transition-all duration-300">
            <div class="p-6">
                ...
                {{-- Changed text --}}
                <p class="text-sm text-gray-500 mb-4">See your grades and GPA progress.</p>
...
{{-- 
  These @push directives are no longer needed 
  because dashboard-layout.blade.php already loads the necessary assets.
